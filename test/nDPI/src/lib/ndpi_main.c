...
static void ndpi_init_protocol_defaults(struct ndpi_detection_module_struct *ndpi_mod) {
  ...
  u_int16_t no_master[2] = { NDPI_PROTOCOL_NO_MASTER_PROTO, NDPI_PROTOCOL_NO_MASTER_PROTO },
    ...
    ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_ACCEPTABLE, NDPI_SERVICE_HANGOUT,
			    ...
			    ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */);
    /*SCADA 协议添加端口处*/
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_SCADA, NDPI_PROTOCOL_S7COMM,
			    no_master,
			    no_master, "ICS S7comm",
			    ndpi_build_default_ports(ports_a, 102, 0, 0, 0, 0) /* TCP */,
			    ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */);
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_SCADA, NDPI_PROTOCOL_MODBUS_TCP,
			    no_master,
			    no_master, "ICS Modbustcp",
			    ndpi_build_default_ports(ports_a, 502, 0, 0, 0, 0) /* TCP */,
			    ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */);
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_SCADA, NDPI_PROTOCOL_ETHERNET,
			    no_master,
			    no_master, "ICS Etherntetip",
			    ndpi_build_default_ports(ports_a, 44818, 0, 0, 0, 0) /* TCP */,
			    ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */);
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_SCADA, NDPI_PROTOCOL_DNP30,
		    	no_master,
		    	no_master, "ICS DNP3.0",
		    	ndpi_build_default_ports(ports_a, 20000, 0, 0, 0, 0) /* TCP */,
		    	ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */);
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_SCADA, NDPI_PROTOCOL_SBUS,
    			no_master,
   				no_master, "ICS S-BUS",
    			ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */,
    			ndpi_build_default_ports(ports_b, 5050, 0, 0, 0, 0) /* UDP */);
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_SCADA, NDPI_PROTOCOL_ESIO,
			    no_master,
			    no_master, "ICS ESIO",
			    ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */,
			    ndpi_build_default_ports(ports_b, 6060, 0, 0, 0, 0) /* UDP */);
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_SCADA, NDPI_PROTOCOL_OMRON,
			    no_master,
			    no_master, "ICS Omron",
			    ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */,
			    ndpi_build_default_ports(ports_b, 9600, 0, 0, 0, 0) /* UDP */);
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_SCADA, NDPI_PROTOCOL_IEC104,
			    no_master,
			    no_master, "ICS IEC104",
			    ndpi_build_default_ports(ports_a, 2404, 0, 0, 0, 0) /* TCP */,
			    ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */);
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_SCADA, NDPI_PROTOCOL_BACNET,
			    no_master,
			    no_master, "ICS BacNet",
			    ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */,
			    ndpi_build_default_ports(ports_b, 47808, 0, 0, 0, 0) /* UDP */);
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_SCADA, NDPI_PROTOCOL_HARTIP,
			    no_master,
			    no_master, "ICS HartIp",
			    ndpi_build_default_ports(ports_a, 5094, 0, 0, 0, 0) /* TCP */,
			    ndpi_build_default_ports(ports_b, 5095, 0, 0, 0, 0) /* UDP */);
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_SCADA, NDPI_PROTOCOL_RTPS,
			    no_master,
			    no_master, "ICS RTSP",
			    ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */,
			    ndpi_build_default_ports(ports_b, 10000, 0, 0, 0, 0) /* UDP */);
...
void ndpi_debug_printf(u_int32_t protocol, void *id_struct,	 	
					  ...
					  const NDPI_PROTOCOL_BITMASK * dbm)
{
  ...
  /* ----------------------------------------------------------------- */
  init_s7comm_dissector(ndpi_struct, &a, detection_bitmask);
  init_mobustcp_dissector(ndpi_struct, &a, detection_bitmask);
  init_ethernetip_dissector(ndpi_struct, &a, detection_bitmask);
  init_BacNet_dissector(ndpi_struct, &a, detection_bitmask);
  init_IEC104_dissector(ndpi_struct, &a, detection_bitmask);
  init_Omron_dissector(ndpi_struct, &a, detection_bitmask);
  init_ESIO_dissector(ndpi_struct, &a, detection_bitmask);
  init_SBUS_dissector(ndpi_struct, &a, detection_bitmask);
  init_DNP30_dissector(ndpi_struct, &a, detection_bitmask);
  init_HartIp_dissector(ndpi_struct, &a, detection_bitmask);
  init_RTPS_dissector(ndpi_struct, &a, detection_bitmask);
					    ...
					    struct ndpi_id_struct *dst)
{
 ...
 ret_protocols:
  ...
  if(flow->protocol_need_everypacketcheck==1)
  	{

     NDPI_LOG(0, ndpi_struct, NDPI_LOG_DEBUG, "START CHECK PACKET :%d",flow->detected_protocol_stack[0]);      
    }
